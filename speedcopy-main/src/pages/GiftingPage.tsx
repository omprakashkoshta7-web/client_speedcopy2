...
import { getPlaceholderImage, resolveThumbnail } from '../utils/image.utils';
              ...
              {loading ? (
                ...
                filteredProducts.map((product: any) => {
                  ...
                  <div
                    ...
                    className="bg-white rounded-2xl overflow-hidden cursor-pointer hover:shadow-md transition relative"
                  ...
                  >
                    <div style={{ height: '220px', backgroundColor: '#f0f0f0' }} className="relative">
                      {/* Discount Badge */}
                      ...
                      <img
                        src={resolveThumbnail(product.images, product.thumbnail, product.image, product.imageUrl) || getPlaceholderImage()}
                        alt={product.name}
                        loading="lazy"
                        decoding="async"
                    ...
                    <div className="p-4">
                      <p className="font-bold text-gray-900 text-sm mt-1.5 mb-2">{product.name}</p>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-5">
            {loading ? (
              ...
              favoriteProducts.map((product: any) => {
                ...
                return (
                <div key={product._id || product.id} className="bg-white rounded-2xl overflow-hidden cursor-pointer hover:shadow-md transition relative" style={{ border: '1px solid #f3f4f6' }}
                  onClick={() => {
                    const productId = product._id || product.id;
                  ...
                  <div style={{ height: '220px', backgroundColor: '#f0f0f0' }} className="relative">
                    ...
                    <img src={resolveThumbnail(product.images, product.thumbnail, product.image, product.imageUrl) || getPlaceholderImage()} alt={product.name} loading="lazy" decoding="async" className="w-full h-full object-cover" />
                  </div>
                  <div className="p-4">
                    <p className="font-bold text-gray-900 text-sm mt-1.5 mb-2">{product.name}</p>
