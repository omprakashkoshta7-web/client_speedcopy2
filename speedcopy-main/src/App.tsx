...
const EDITOR_ROUTES = ['/design-editor', '/simple-frame-editor', '/canvas-editor', '/document-editor', '/card-editor', '/customization-editor'];
...
// Simple full-screen loading fallback for lazy-loaded routes
...
const CustomizationEditorPage = lazy(() => import('./pages/CustomizationEditorPage'));
