                ...
                if (isShoppingFlow) {
                  return (
                    <div
                      ...
                      className="bg-white rounded-xl overflow-hidden cursor-pointer hover:shadow-lg transition group"
                      style={{ boxShadow: '0 1px 4px rgba(0,0,0,0.06)', border: '1px solid #f3f4f6' }}
                    >
                      <div className="relative">
                        {product.badge && (
                          <div
                            className="absolute top-2 left-2 z-10 px-1.5 py-0.5 rounded text-white text-[9px] font-bold"
                        ...
                        <div className="rounded-t-xl overflow-hidden h-36 flex items-center justify-center" style={{ backgroundColor: '#f8fafc' }}>
                          <img src={getProductImage(product)} alt={product.name} className="w-full h-full object-cover group-hover:scale-105 transition duration-300" />
                        </div>
                      </div>
